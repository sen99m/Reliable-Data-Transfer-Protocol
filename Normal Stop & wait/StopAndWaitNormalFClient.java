...
package stopandwaitnormalfclient;
...
public class StopAndWaitNormalFClient {
public static byte[] REQUEST = new byte[] { 0x52, 0x69,0x51, 0x55, 0x45, 0x53, 0x54};//prepended in 1st message sent by client
	...
	public static void main(String[] args) {
		...
		try {
			...
			fos = new FileOutputStream("demoSound1.mp3");
			...
			while(!end)
			{
                            ...
                            if(count==0)//REQUESTfilenameCRLF
                            {
                                ...
                                String ack="demoSound.mp3";   //write filename accordingly!!!
                                sd=ack.getBytes();	
			    ...
			    cs.receive(rp);	
                            ...
                            //consignment = new String(replyInByte, MESSAGE_START.length, 1);
